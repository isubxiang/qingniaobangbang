...
function getSign(e, t, n) {
    var a = require("underscore.js"), r = require("md520.js"), i = "", o = getUrlParam(e, "sign");
...
util.url = function(e, t) {
    ...
    e[2] && (a += "/" + e[2])), t && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var r in t) r && t.hasOwnProperty(params) && t[r] && (a += r + "=" + t[r] + "&");
    return a;
}, util.request = function(a) {
    require("underscore.js");
    var e, t = require("md520.js"), r = getApp();
    ...
    !a.data || !a.data.m) {
        ...
        o.length && (o = o[getCurrentPages().length - 1]) && o.__route__ && (i = i);
    }
    ...
    wx.request((_defineProperty(e = {
        ...
        console.log("==========_defineProperty===========",e.data);
        ...
        var t = require("md520.js")(i), n = wx.getStorageSync(t);
