...
<div class="tu-main-top-btn">
    <ul>
        ...
        <li class="li2 li3">新增分类</li>
    </ul>
</div>
<div class="main-tudou-sc-add ">

    <div class="tu-table-box">
        <form  target="x-frame" action="<?php echo U('runningcate/create');?>" method="post">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
                <tr>
                    <td class="tu-left-td">所属频道：</td>
                    <td class="tu-right-td">
                        <select class="tu-manage-select w200" name="data[channel_id]">
                ...
                <tr>
                    ...
                    <td class="tu-right-td">
                        <input type="text" name="data[cate_name]" value="<?php echo (($detail["cate_name"])?($detail["cate_name"]):''); ?>" class="tudou-manageInput w200" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <code>当前分类配送开始时间，请注意时间格式，英文状态下的小写才行，默认：8:00【一定要注意格式不要写错，30分钟为一个去区间，比如8:30】</code>
                    </td>
                </tr>
                <tr>
                    ...
                    <code>当前分类配送结束时间，请注意时间格式，英文状态下的小写才行，默认：22:00【一定要注意格式不要写错，30分钟为一个去区间，比如8:30】</code>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tu-right-td"><input type="text" name="data[price]" value="<?php echo (($detail["price"])?($detail["price"]):''); ?>" class="tudou-manageInput w200" />
