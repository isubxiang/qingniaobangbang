...
<div class="tu-main-top-btn">
    <ul>
        <li class="li1">设置</li>
        <li class="li2">短信模板</li>
        <li class="li2 li3">短信宝模版</li>
    </ul>
</div>
<div class="main-tu-js">
    <p class="attention"><span>注意：</span>这里只要是针对的短信宝接口，记住模板状态要开启哦！</p>
    <div class="tudou-js-nr">
        <div class="tu-select-nr" style="margin: 10px 20px;">
            <div class="left">
                <?php echo BA('sms/create','','添加内容');?>
                <?php echo BA('smsbao/index','','短信发送记录');?>
            </div>
        </div>
        <form target="x-frame" method="post">
            <div class="tu-table-box">
                <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                            ...
                            <td>
                                <?php echo BA('sms/edit',array("sms_id"=>$var["sms_id"]),'编辑','','tu-dou-btn');?>
                                <?php if(($var["is_open"]) == "0"): echo BA('sms/audit',array("sms_id"=>$var["sms_id"]),'开启','act','tu-dou-btn');?> 
                        <?php else: ?>
                        <?php echo BA('sms/delete',array("sms_id"=>$var["sms_id"]),'关闭','act','tu-dou-btn'); endif; ?>
            ...
            <div class="tu-select-nr">
                <div class="left">
                    ...
                    <?php echo BA('sms/audit','','批量开启','list','tu-dou-btn');?>
                </div>
            </div>
        </form>
