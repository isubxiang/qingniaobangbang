...
<div class="main-tu-js">
    ...
    <div class="tudou-js-nr">
        ...
        <form  id="export-form" target="x-frame" method="post" action="<?php echo U('export');?>">
            <div class="tu-table-box">
                <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="action">
                                <a class="tu-dou-btn" href="<?php echo U('optimize?tables='.$table['name']);?>">优化表</a>&nbsp;
                                <a class="tu-dou-btn" href="<?php echo U('repair?tables='.$table['name']);?>">修复表</a>
                            </td>
