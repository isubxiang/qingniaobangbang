...
<div class="tu-main-top-btn">
    <ul>
        <li class="li1">提现管理</li>
        <li class="li2">商家提现</li>
        <li class="li2 li3">提现列表</li>
    </ul>
</div>
<div class="main-tu-js main-sc">
<p class="attention"><span>注意：</span>新版提现管理可以查询，商家总提现【已审】：<?php echo ($shop_cash); ?>！商家提现佣金【已审】：<?php echo ($shop_cash_commission); ?>元，商户资金暂时不支持微信提现</p>
    <div class="tudou-js-nr">
        <div class="tu-select-nr" style="margin-top: 0px; border-top:none;">
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('usercash/gold');?>">
        ...
        <div class="tu-table-box">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        ...
                        <td>
                            <p><?php echo ($var["bank_name"]); ?> / 支行：<?php echo ($var["bank_branch"]); ?></p>
                            <p><?php echo ($var["bank_realname"]); ?> / 卡号：<?php echo ($var["bank_num"]); ?></p>
                        </td>
                        <td>
                        ...
                        <td>&yen;<?php echo ($var['gold'] / 100); ?> 元</td>
                        <td><?php if(!empty($var['commission'])): ?>手续费：&yen; <?php echo round($var['commission']/100,2);?>元<?php else: ?>无<?php endif; ?></td>
                        <td>
                    ...
                    <td>
                     	...
                     	<?php if($var["status"] == 0): if($var['code'] == weixin): echo BA('usercash/weixin_audit',array("cash_id"=>$var["cash_id"], "status" => 1),'微信转账','act','tu-dou-btn weixin'); endif; ?>
                            ...
                            <?php if($var['code'] == bank): echo BA('usercash/bank_audit_gold',array("cash_id"=>$var["cash_id"], "status" => 1),'通过','act','tu-dou-btn'); endif; ?>
