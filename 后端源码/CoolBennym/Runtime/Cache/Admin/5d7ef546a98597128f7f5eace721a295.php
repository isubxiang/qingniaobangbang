...
<form  target="x-frame" action="<?php echo U('shop/create');?>" method="post">
    <div class="main-tudou-sc-add">
                ...
                <tr>
                    ...
                    <td class="tu-right-td">
                        <div class="lt">
                            ...
                            <input class="tudou-sc-add-text-name w210 sj" type="text" name="nickname" id="nickname"  value="" />
                        </div>
       ...
       <tr>
        ...
        <tr>
            ...
            <td class="tu-right-td"><input type="text" name="data[contact]" value="<?php echo (($detail["contact"])?($detail["contact"]):''); ?>" class="tudou-sc-add-text-name w210" />
            </td>
        </tr>
        ...
        <tr>
            <td class="tu-left-td">人均消费：</td>
            <td class="tu-right-td"><input type="text" name="data[price]" value="<?php echo (($detail["price"])?($detail["price"]):'0'); ?>" class="tudou-sc-add-text-name w210" />
            </td>
        </tr>
