...
class PublicAction extends CommonAction
{
    ...
    //升级之前需要请求Tudou看看是否是授权用户，Tudou会进行回调验证TOKEN授权的
    public function token()
    {
        $url = 'http://www.taobao.com/update/token.html?host=' . urlencode($_SERVER['HTTP_HOST']) . '&bao_key=' . C('TU_KEY');
