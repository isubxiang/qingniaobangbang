...
class ArticleAction extends CommonAction{
    private $create_fields = array( 'title','cate_id', 'source', 'keywords', 'profiles', 'desc', 'photo', 'details');
    private $edit_fields = array( 'title','cate_id',  'source', 'keywords', 'profiles', 'desc', 'photo', 'details');
   
   
   
	public function _initialize(){
        parent::_initialize();
        $this->assign('getCateIds', D('Article')->getCateIds());
    }
    ...
    public function index(){
		...
		if($cate_id = $this->_param('cate_id', 'htmlspecialchars')){
            $map['cate_id'] = $cate_id;
